...
class _AssetListPageState extends State<AssetListPage> {
  ...
  Widget build(BuildContext context) {
    final filteredAssets = allAssets.where((asset) {
      ...
      final matchesCategory = selectedCategory == null || asset.category == selectedCategory;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => const DisposalListPage()));
            },
          ),
        ],
      ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  onSelected: (value) => setState(() => selectedCategory = value == "All" ? null : value),
                  itemBuilder: (_) => [
            ...
            Align(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (_) => const AddAssetPage()));
                },
              ),
            ),
            const SizedBox(height: 16),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(asset.id, style: const TextStyle(fontWeight: FontWeight.bold)),
                          Text(asset.name),
                        ],
                      ),
                    ),
